...
const eventEl=document.getElementById('gameEvent');
const pixels=[];
...
// At 9 pixels wide, a diagonal ball can cross from directly above a paddle edge to
// one pixel outside it in a single tick. Treat either endpoint of that one-pixel path
// as contact so a visually obvious deflection is never scored as a miss.
